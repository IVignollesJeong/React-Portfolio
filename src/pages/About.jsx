...
export default function About() {
  return (
    <div>
      ...
      <img className="about" src={headshot} width="300" height="400" id="img"></img>
      <p>Welcome to Ian Vignolles-Jeong's professional portfolio! As an aspiring web app developer, it brings me
